...
@Component({
  selector: 'app-post-card-actors',
  templateUrl: './post-card-actors.component.html',
  styleUrls: ['./post-card-actors.component.scss'],
})
export class PostCardActorsComponent implements OnInit {
  @Input() cardData: any;
